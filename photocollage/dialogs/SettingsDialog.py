...
class SettingsDialog(Gtk.Dialog):
    def __init__(self, parent):
        ...
        self.selected_border_color = parent.with_title.border_c
        ...
        self.etr_outw = Gtk.Entry(text=str(parent.with_title.out_w))
        ...
        self.etr_outh = Gtk.Entry(text=str(parent.with_title.out_h))
        ...
        self.etr_border = Gtk.Entry(text=str(50.0 * parent.with_title.border_w))
        ...
        color = Gdk.RGBA()
        color.parse(parent.with_title.border_c)
